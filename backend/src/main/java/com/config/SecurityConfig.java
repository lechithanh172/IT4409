...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers("/user/customer").hasAnyRole("ADMIN")
                        .requestMatchers("/user/product_manager").hasAnyRole("ADMIN")
                        ...
                        .requestMatchers("/order/assign/").hasAnyRole("ADMIN", "SHIPPER")
                        .requestMatchers("/order/status/").hasAnyRole("ADMIN", "SHIPPER")
    ...
    public CorsConfigurationSource corsConfigurer() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:5173", "https://lehaanhduc.io.vn"));
