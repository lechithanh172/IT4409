      ...
      <div className={styles.container}>
        <div className={styles.footerContent}>
          ...
          <div className={styles.footerColumn}>
            ...
            <p className={styles.footerText}>Email: support@myeshop.com</p>
            <p className={styles.footerText}>Điện thoại: (028) 1234 5678</p>
          </div>
        </div>
