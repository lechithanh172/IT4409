        ...
        <nav className={styles.desktopNav}>
          ...
          <div className={styles.dropdownContainer} ref={categoryDropdownRef}>
            ...
            >
              Danh Mục{" "}
              <FiChevronDown
                className={`${styles.chevronIcon} ${isCategoryDropdownOpen ? styles.chevronOpen : ""
                  }`}
              />
            </button>
            ...
            {isLoggedIn ? (
              <div className={styles.dropdownContainer} ref={userDropdownRef}>
                ...
                >
                  <FiUserCheck />
                  <FiChevronDown
                    className={`${styles.chevronIcon} ${styles.userChevron} ${isUserDropdownOpen ? styles.chevronOpen : ""
                      }`}
                  />
                </button>
                {isUserDropdownOpen && (
